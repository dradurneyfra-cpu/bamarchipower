import chandelierGoldRing from "@/assets/elec-chandelier-gold-ring.jpg";
import crystalChandelier from "@/assets/elec-crystal-chandelier.jpg";
import goldPendantLight from "@/assets/elec-gold-pendant-light.jpg";
import switchesBlack from "@/assets/elec-switches-sockets-black.jpg";
import switchesGold from "@/assets/elec-switches-sockets-gold.jpg";
import wallLighting from "@/assets/elec-wall-lighting.jpg";
import solarRoof1 from "@/assets/solar-rooftop-install-1.jpg";
import solarRoof2 from "@/assets/solar-rooftop-install-2.jpg";
import inverterUnit from "@/assets/solar-inverter-unit.jpg";
import inverterController from "@/assets/solar-inverter-controller.jpg";
import dcWiring from "@/assets/solar-dc-wiring-protection.jpg";
import archDrawingSet from "@/assets/arch-drawing-set.jpg";
import archMosqueModel from "@/assets/arch-mosque-model.jpg";
import archCaseStudy from "@/assets/arch-case-study.jpg";
import archDeductions from "@/assets/arch-design-deductions.jpg";
import logoLight from "@/assets/bam-logo-light.jpg";
import logoDark from "@/assets/bam-logo-dark.jpg";
...
export const HERO_IMAGE = solarRoof1;
export const ABOUT_IMAGE = archMosqueModel;

export const SERVICE_IMAGES: Record<string, string> = {
  Electrical: chandelierGoldRing,
  Architecture: archDrawingSet,
  "Solar & Inverter": solarRoof2,
};
